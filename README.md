...
`git delete NoctiBeard-c2t_hccs-master`
...
* [Bird-a-Day calendar](https://kol.coldfront.net/thekolwiki/index.php/Bird-a-Day_calendar) &mdash; Saves if fav'd item buff/ weapon buff
